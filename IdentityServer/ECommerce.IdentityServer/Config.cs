...
namespace ECommerce.IdentityServer
{
    public static class Config
    {
        public static IEnumerable<ApiResource> ApiResources => new ApiResource[]
        {
            ...
            new ApiResource("ResourceBasketFull") { Scopes = { "OrderFullPermission" } },
        ...
        public static IEnumerable<Client> Clients => new Client[]
        {
            ...
            new Client
            {
                ...
                ClientSecrets={new Secret("ecommercesecret".Sha256())},
                AllowedScopes={ "DiscountFullPermission", "CatalogFullPermission", "OrderFullPermission", "BasketFullPermission", IdentityServerConstants.LocalApi.ScopeName },
